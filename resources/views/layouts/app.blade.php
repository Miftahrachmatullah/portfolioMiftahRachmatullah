...
<html lang="id">
  <head>
    ...
    <style>
      ...
      * {
      ...
      .section-heading .underline-stroke {
        display: block;
        height: 5px;
        background: #ffe44d;
        border: 2px solid #1a1a1a;
  ...
  <body>
    ...
    <nav id="navbar">
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between h-16">
          <a
            href="#hero"
            class="font-syne font-extrabold text-xl tracking-tight"
            style="font-family: &quot;Syne&quot;, sans-serif"
            >MR<span style="color: #ff6b6b">Portfolio</span
            ><span style="color: #ffe44d">.</span></a
          >
      ...
      <div class="max-w-6xl mx-auto">
        ...
        >
          ...
          <div class="flex gap-3">
            <a
              href="https://github.com/Miftahrachmatullah"
              target="_blank"
              class="social-icon"
              title="GitHub"
            >
            ...
            <a
              href="https://www.linkedin.com/in/miftahrachmatullah/"
              target="_blank"
              class="social-icon"
              title="LinkedIn"
            >
            ...
            <a
              href="https://www.instagram.com/miftahrachmatullah?igsh=MWY5N2gxY3hvbGp1bQ=="
              target="_blank"
              class="social-icon"
              title="Instagram"
            >
              <img
                src="https://img.icons8.com/ios-glyphs/30/instagram-circle.png"
                alt="Instagram"
                style="width: 20px; height: 20px"
              />
            </a>
    ...
    <script>
      ...
      animRing();
      document
        .querySelectorAll("a,button,.nb-card,.skill-badge")
        .forEach((el) => {
      ...
      document
        ...
        .addEventListener("submit", function (e) {
          ...
          const mailto = `mailto:mochamadmiftah34@gmail.com?subject=${subject}&body=${body}`;
