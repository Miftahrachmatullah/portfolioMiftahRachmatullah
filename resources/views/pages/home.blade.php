...
<section id="projects" class="py-24 px-4 sm:px-6" style="background:#fffdf0">
  <div class="max-w-6xl mx-auto">
    <div class="reveal flex items-end justify-between flex-wrap gap-4">
      ...
      <span style="font-family:'DM Mono',monospace;font-size:0.8rem;border:2px solid #1a1a1a;padding:4px 12px;background:#ffe44d;">09 PROJECTS</span>
    </div>

    <!-- FILTER BUTTONS -->
    <div class="mt-8 flex flex-wrap gap-3" id="project-filters">
    ...
    <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <!-- Project 1 -->
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="backend laravel fullstack"
        data-title="VentiFlow Sistem Inventarisasi"
        data-summary="Sistem pengelola inventaris barang mudah, cepat, dan real-time untuk manufaktur modern."
        data-description="VentiFlow membantu perusahaan melacak pergerakan stok, stok masuk/keluar, serta mendeteksi barang hilang atau kadaluarsa secara instan. Akurasi pendataan stok meningkat hingga 99.8% dan memangkas waktu opname dari 3 hari menjadi 4 jam."
        data-technologies="Laravel,Tailwind,PostgreSQL"
        data-img="/img/ventiflow.png"
        data-demo-url="https://example.com/ventiflow">
        <img src="/img/ventiflow.png" alt="VentiFlow" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">VentiFlow Sistem Inventarisasi</h3>
          <p class="text-xs mt-1" style="color:#555">Sistem pengelola inventaris barang mudah real-time.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">Laravel</span><span class="tag-pill">Tailwind</span><span class="tag-pill">PostgreSQL</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>

      <!-- Project 2 -->
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="frontend ui/ux"
        data-title="Landing Page RS Kembang Harapan"
        data-summary="Landing page informasi layanan, jadwal dokter, dan pendaftaran rawat jalan RS Kembang Harapan."
        data-description="Website portal resmi untuk RS Kembang Harapan yang memberikan akses ramah pasien untuk konsultasi dan reservasi jadwal dokter. Meningkatkan pendaftaran online sebesar 40% dalam bulan pertama peluncuran."
        data-technologies="React,SQL,Laravel"
        data-img="/img/landing-page-rs-kembang.png"
        data-demo-url="https://example.com/rs-kembang">
        <img src="/img/landing-page-rs-kembang.png" alt="RS Kembang Harapan" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">Landing Page RS Kembang Harapan</h3>
          <p class="text-xs mt-1" style="color:#555">Landing page untuk RS Kembang Harapan.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">React</span><span class="tag-pill">SQL</span><span class="tag-pill">Laravel</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>
      ...
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="frontend ui/ux"
        data-title="StayLux Hotel"
        data-summary="Platform Booking Hotel dengan Harga Terjangkau dan Pengalaman Antarmuka Modern."
        data-description="StayLux Hotel memungkinkan pengguna mengeksplorasi kamar, mengecek ketersediaan tanggal secara live, dan memesan akomodasi dengan mudah. Conversion rate pemesanan kamar di mobile meningkat 25%."
        data-technologies="Html,Tailwind,Figma"
        data-img="/img/styalux.png"
        data-demo-url="https://example.com/staylux">
        <img src="/img/styalux.png" alt="StayLux Hotel" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">StayLux Hotel</h3>
          <p class="text-xs mt-1" style="color:#555">Platform Booking Hotel dengan Harga Terjangkau.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">Html</span><span class="tag-pill">Tailwind</span><span class="tag-pill">Figma</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>
      ...
      <!-- Project 4 -->
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="frontend fullstack"
        data-title="Helpdesk BigBox"
        data-summary="Platform penyedia AI untuk solusi tiket helpdesk dan respon otomatis customer service perusahaan."
        data-description="Helpdesk BigBox mengintegrasikan engine AI untuk mengategorikan tiket keluhan pelanggan secara otomatis dan mempercepat penyelesaian masalah. Waktu respon penanganan keluhan pelanggan berkurang hingga 60%."
        data-technologies="Figma,Tailwind,Javascript"
        data-img="/img/bigbox.png"
        data-demo-url="https://example.com/bigbox">
        <img src="/img/bigbox.png" alt="Helpdesk BigBox" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">Helpdesk BigBox</h3>
          <p class="text-xs mt-1" style="color:#555">Platform penyedia AI untuk solusi perusahaan.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">Figma</span><span class="tag-pill">Tailwind</span><span class="tag-pill">Javascript</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>
      ...
      <!-- Project 5 -->
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="ui/ux"
        data-title="Inclusive Space"
        data-summary="Platform pembelajaran inklusif yang dirancang untuk mendukung aksesibilitas semua siswa."
        data-description="Inclusive Space memberikan materi pembelajaran interaktif dengan penekanan pada keterbacaan, dukungan screen reader, dan kontras warna tinggi. Meraih skor aksesibilitas 98/100 pada audit UI edutech nasional."
        data-technologies="Canva,Figma"
        data-img="/img/inclusive-space.png"
        data-demo-url="#">
        <img src="/img/inclusive-space.png" alt="Inclusive Space" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">Inclusive Space</h3>
          <p class="text-xs mt-1" style="color:#555">Platform pembelajaran inclusive.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">Canva</span><span class="tag-pill">Figma</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>
      ...
      <!-- Project 6 -->
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="ui/ux frontend"
        data-title="Sister Sarpas & Sisarpras"
        data-summary="Sistem Layanan Pengelolaan dan Pengajuan Sarana & Prasarana Perguruan Tinggi Negeri."
        data-description="Sistem terpadu untuk memproses pengajuan pemeliharaan, inventarisasi gedung, dan alokasi fasilitas kampus. Memangkas birokrasi pengajuan sarpras dari 14 hari menjadi 2 hari."
        data-technologies="Canva,Figma,Tailwind"
        data-img="/img/sisarpras.png"
        data-demo-url="https://example.com/sisarpras">
        <img src="/img/sisarpras.png" alt="Sister Sarpas & Sisarpras" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">Sister Sarpas & Sisarpras</h3>
          <p class="text-xs mt-1" style="color:#555">Sistem Layanan Sarana dan Prasarana PTN.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">Canva</span><span class="tag-pill">Figma</span><span class="tag-pill">Tailwind</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>
      ...
      <!-- Project 7 -->
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="frontend laravel fullstack"
        data-title="MR Coffee"
        data-summary="MR Coffee is a modern landing page for an artisanal coffee shop website."
        data-description="Landing page promo kedai kopi modern dengan fitur eksplorasi menu, reservasi meja, dan pemesanan biji kopi secara online. Website dikunjungi lebih dari 5.000 pengguna pada minggu pertama launching."
        data-technologies="Tailwind,Javascript,Laravel"
        data-img="/img/mr-coffee.png"
        data-demo-url="https://example.com/mr-coffee">
        <img src="/img/mr-coffee.png" alt="MR Coffee" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">MR Coffee</h3>
          <p class="text-xs mt-1" style="color:#555">MR Coffee is a modern landing page for a coffee shop website.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">Tailwind</span><span class="tag-pill">Javascript</span><span class="tag-pill">Laravel</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>
      ...
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="frontend ui/ux"
        data-title="NexaData Startup"
        data-summary="Platform analitik big data untuk visualisasi performa bisnis perusahaan modern."
        data-description="NexaData mengubah jutaan titik data menjadi grafik analitik interaktif yang mudah dipahami oleh eksekutif perusahaan. Dugaan insight bisnis dapat disimpulkan 3x lebih cepat oleh tim manajemen."
        data-technologies="Tailwind,Figma,Vanilla JavaScript"
        data-img="/img/nexadata.png"
        data-demo-url="https://example.com/nexadata">
        <img src="/img/nexadata.png" alt="NexaData Startup" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">NexaData Startup</h3>
          <p class="text-xs mt-1" style="color:#555">Platform analitik big data untuk perusahaan modern.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">Tailwind</span><span class="tag-pill">Figma</span><span class="tag-pill">Vanilla JavaScript</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>
      ...
      <div class="project-card reveal nb-card bg-white overflow-hidden"
        data-categories="frontend ui/ux"
        data-title="Volva EV Landing Page"
        data-summary="Premium Electric Vehicle Landing Page untuk showcase mobil listrik masa depan."
        data-description="Showcase interaktif kendaraan listrik premium dengan fitur configurator warna dan pemesanan test drive. Meningkatkan permohonan test drive kendaraan listrik sebesar 35%."
        data-technologies="HTML,CSS,Tailwind,JavaScript"
        data-img="/img/volva.png"
        data-demo-url="https://example.com/volva-ev">
        <img src="/img/volva.png" alt="Volva EV" class="w-full h-40 object-cover project-thumb" />
        <div class="p-4">
          <h3 style="font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;">Volva EV Landing Page</h3>
          <p class="text-xs mt-1" style="color:#555">Premium Electric Vehicle Landing Page.</p>
          <div class="flex flex-wrap gap-1 mt-3">
            <span class="tag-pill">HTML</span><span class="tag-pill">CSS</span><span class="tag-pill">Tailwind</span><span class="tag-pill">JavaScript</span>
          </div>
          <button class="open-modal-btn nb-btn nb-btn-yellow px-4 py-2 text-xs mt-4 w-full text-center">VIEW PROJECT</button>
        </div>
      </div>
